...
const StoreDetail = () => {
    ...
    const storeBannerImg = '/images/cards/banner.png';
                ...
                <div className="flex flex-col md:flex-row gap-6 md:gap-8 rounded-2xl bg-white py-6 md:py-8 px-4 md:px-8">
                    ...
                    <div className="flex-1 flex flex-col gap-4 md:gap-6 py-2 md:py-4">
                        ...
                        <div className="flex justify-end mt-auto">
                            <button
                                className="
                                    w-24 h-9 sm:w-28 md:w-30.25 md:h-9.5 
                                    flex items-center justify-center 
                                    rounded-lg border border-[#1090B2]
                                    text-[#1090B2] text-[12px] sm:text-[13px] md:text-[14px] 
                                    font-inter font-medium 
                                    hover:bg-[#cfefff] bg-[#DFF5FF] 
                                    transition
                                "
                            >
                                Read more
