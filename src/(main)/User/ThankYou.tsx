        ...
        <div className='flex justify-center py-5'>
            <div className=' w-full'>
                <div className="flex justify-center px-3">
                    <div
                        className="w-full max-w-193.25 border rounded-lg mb-5 overflow-hidden relative flex">
                        ...
                        <div
                            className="w-35 sm:w-53.75 h-12 sm:h-16 rounded-full absolute -right-4 sm:-right-7 flex justify-center items-center gap-1 sm:gap-2
                            bg-[#2B6777] ">
                ...
                <div className='p-5 bg-[#FBFCFC] rounded-lg shadow-sm'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 items-start'>
                        ...
                        <div className='w-full flex justify-start sm:justify-end'>
                            <div className="bg-[#15997226] font-semibold flex items-center justify-center gap-3 sm:gap-4 px-4 py-2 w-full sm:w-43.25 h-10 rounded-[22px] border border-[#159972] text-sm sm:text-base">
                                Purchased
                    ...
                    <div className="w-full border-b md:border-b-0 md:border-r border-[#afaeae] flex justify-center pb-6 md:pb-0">
                        <div className="text-center  md:text-left">
                            ...
                            <p className="font-inter text-[#828282] font-normal text-[12px] mb-6 leading-[120%] text-center tracking-normal">
                                ...
                                <br />
                                or manually enter the code in the POS
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 mt-7 gap-6">
                    <div className="w-full flex items-center gap-4 p-3 bg-[#F9A20126] border border-dashed border-[#F9A201] rounded-lg">
                        <div className="w-20 h-20 bg-orange-500 rounded-md shrink-0"></div>
