        ...
        <div className='flex justify-center py-5'>
            <div className=' w-full'>
                <div className="flex justify-center px-3 overflow-hidden  ">
                    <div
                        className="w-full max-w-193.25 border-2 border-[#c9c8c8]/50 rounded-xl shadow-lg  mb-5 overflow-hidden relative flex">
                        ...
                        <div
                            className="
                                w-35 sm:w-53.75 h-72 
                                absolute top-1/2 rotate-[-40deg] -translate-y-1/2 -right-5 
                                shadow-black shadow-xl 
                                flex justify-center items-center gap-1 sm:gap-2
                                bg-[#D22E2D] 
                            "
                        >
                            <span className="font-sans font-semibold text-white text-[13px] rotate-40 flex items-center gap-2 justify-center sm:text-[16px] leading-[100%]">
                ...
                <div className='p-5 bg-[#FBFCFC] rounded-lg shadow-sm'>
                    ...
                    <div className='grid grid-cols-1 sm:grid-cols-2 gap-4 items-start'>
                        ...
                        <div className='w-full flex justify-start sm:justify-end'>
                            <div className="bg-[#991515f1] text-white font-semibold flex items-center justify-center gap-3 sm:gap-4 px-4 py-2 w-full sm:w-43.25 h-10 rounded-[22px]  text-sm sm:text-base">
                                Failed
